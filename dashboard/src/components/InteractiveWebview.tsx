...
export const InteractiveWebview = ({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Webview panel */}
      <div
        className="relative min-h-[24rem] overflow-hidden rounded-xl border border-slate-700 bg-slate-950 sm:aspect-video sm:min-h-0"
        role="region"
        ...
        <AnimatePresence mode="wait">
          ...
          {webviewState === 'idle' && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 flex flex-col items-center justify-center gap-4 p-4 text-center sm:p-6"
            >
          ...
          {webviewState === 'loading' && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 flex flex-col items-center justify-center gap-5 p-4 sm:p-6"
            >
              ...
              <div className="flex flex-1 flex-col items-center justify-center gap-4 p-4 sm:p-6">
                ...
                <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-lg border border-slate-700 px-4 py-2 text-sm text-slate-400 transition-all hover:border-rose-500/40 hover:text-rose-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500/50"
          ...
          {webviewState === 'approved' && (
            <motion.div
              ...
              className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-4 text-center sm:p-6"
            >
